            ...
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    ...
                    <div class="blog-details-header">
                        ...
                        <ul class="post-meta">
                            <li v-if="detail.shangpinUuidNumber">产品编号：
                                {{detail.shangpinUuidNumber}}
                            </li>
                            <li v-if="detail.shangpinTypes">产品类型：
                                {{detail.shangpinValue}}
                            </li>
                            <li v-if="detail.shangpinKucunNumber">产品库存：
                                {{detail.shangpinKucunNumber}}
                            </li>
                            <li v-if="detail.shangpinOldMoney">产品原价：
