					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinUuidNumber" id="shangpinUuidNumber" lay-verify="required" placeholder="产品编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinName" id="shangpinName" lay-verify="required" placeholder="产品名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="shangpinKucunNumber" id="shangpinKucunNumber"  lay-verify="required|integer"   placeholder="产品库存" autocomplete="off" class="layui-input">
							</div>
						</div>
			<div class="layui-form-item">
                <div class="layui-block">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="0" readonly name="shangpinOldMoney" id="shangpinOldMoney"  placeholder="产品原价" autocomplete="off" class="layui-input" style="width: 500px">
