...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input  type="text" name="shangpinUuidNumber" id="shangpinUuidNumber"  lay-verify="required"   placeholder="产品编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
                <label class="layui-form-label">产品名称：</label>
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinName"--%> type="text" name="shangpinName" id="shangpinName" placeholder="产品名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.shangpinKucunNumber"--%> type="text" name="shangpinKucunNumber" id="shangpinKucunNumber" lay-verify="integer|required"   placeholder="产品库存" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" pane>
