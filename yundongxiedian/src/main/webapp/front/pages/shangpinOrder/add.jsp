        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input v-model="shangpin.shangpinKucunNumber" type="text" readonly="readonly" name="shangpinKucunNumber" id="shangpinKucunNumber"   placeholder="产品库存" autocomplete="off" class="layui-input">
                </div>
            </div>
