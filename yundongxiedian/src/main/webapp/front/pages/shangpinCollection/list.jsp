        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                    <div class="index_titlebox">
                        <h3 class="index_title">产品收藏展示</h3>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="shangpinUuidNumber" id="shangpinUuidNumber" placeholder="产品编号" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="shangpinName" id="shangpinName" placeholder="产品名称" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                    ...
                    <%--<div class="container">--%>
                        <div class="row mb-4">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                                ...
                                <a @click="jumpCheck('../shangpin/detail.jsp?id='+item.shangpinId , item.shangpinDelete == null?'':item.shangpinDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="probootstrap-thumbnail">
