    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑产品订单</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">产品订单管理</li>
                        <li class="breadcrumb-item active">编辑产品订单</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">产品订单信息</h3>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            if(window.sessionStorage.getItem('role') != '产品'){//当前登录用户不为这个
                if($("#shangpinId") !=null){
