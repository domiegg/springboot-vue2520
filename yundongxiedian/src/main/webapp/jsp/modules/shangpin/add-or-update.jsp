                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpinKucunNumberDiv">
                                        ...
                                        <input style="width: 450px" id="shangpinKucunNumber" name="shangpinKucunNumber" class="form-control"
                                               onchange="shangpinKucunNumberChickValue(this)"  placeholder="产品库存">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinOldMoneyDiv">
                                        ...
                                        <input style="width: 450px" id="shangpinOldMoney" name="shangpinOldMoney" class="form-control"
                                               onchange="shangpinOldMoneyChickValue(this)" placeholder="产品原价">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                shangpinUuidNumber: "产品编号不能为空",
                shangpinName: "产品名称不能为空",
                shangpinPhoto: "产品照片不能为空",
                shangpinTypes: "产品类型不能为空",
                shangpinKucunNumber: "产品库存不能为空",
                // shangpinOldMoney: "产品原价不能为空",
                // shangpinNewMoney: "现价不能为空",
                shangpinClicknum: "点击次数不能为空",
                shangpinContent: "产品介绍不能为空",
